        ...
        if(Get.currentRoute == '/HomeView') {
          Get.dialog(AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text('Alert', style: TextStyle(fontSize: 21, fontWeight: FontWeight.w600, color: Colors.brown),),
                SizedBox(height: 15),
                Text('Do you want to exit the app?', style: TextStyle(fontSize: 17, color: Colors.brown),),
                SizedBox(height: 25),
                Divider(height: 0,),
                SizedBox(
                  height: 45,
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          width: width * 0.4,
                          child: Text('Yes', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600, color: Colors.blue),),
                        ),
                      ),
                      ...
                      InkWell(
                        ...
                        child: Container(
                          alignment: Alignment.center,
                          width: width * 0.4,
                          child: Text('No', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600, color: Colors.blue),),
                        ),
                      )
                    ],
                  ),
                ...
                Wrap(
                  ...
                  children: List.generate(controller.categoryChips.length, (index) =>
                      InkWell(
                        ...
                        child: Chip(
                          label: Text(controller.categoryChips[index], style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w500, color: Colors.white)),
